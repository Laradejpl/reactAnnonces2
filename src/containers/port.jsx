...
import PlacedePortmg from '../assets/pharelogo.png'
...
const onSubmitForm = () => {
    ...
    return (
        <main className='main_home'>
		  ...
		  <img src={PlacedePortmg} alt="logo application" className="logohome"/>
			<h1 className='titlehomeski'>Place de Port</h1>
		  ...
		  <h2> les meilleurs  Place de Port de France</h2>
