          ...
          return (
            <div className='connected_aside_cat'>
               <ul className="connected_ul">
                        ...
                        <div className='container_cat_inter'>
                        <li><Link to="/voillier"  className="profile_link">Voilier</Link></li>
                        {( screenWidth > 500) && (
                                    <div className='divider'></div>
                          ...
                          <div className='container_cat_inter'>
                          <li><Link to="/yatch"  className="profile_link">Yacht</Link></li>
                          {( screenWidth > 500) && (
                                    <div className='divider'></div>
                          ...
                          <div className='container_cat_inter'>
                          <li><Link to="/peniche"  className="profile_link">Péniche</Link></li>
                          {( screenWidth > 500) && (
                                    <div className='divider'></div>
                          ...
                          <div className='container_cat_inter'>
                          <li><Link to="/semirigide"  className="profile_link">Semi-Rigide</Link></li>
                          {( screenWidth > 500) && (
                                    <div className='divider'></div>
                          ...
                          <div className='container_cat_inter'>
                          <li><Link to="/remorque"  className="profile_link">Remorque</Link></li>
                          {( screenWidth > 500) && (
                                    <div className='divider'></div>
                          ...
                          <div className='container_cat_inter'>
                          <li><Link to="/moteur"  className="profile_link">Moteur</Link></li>
                          {( screenWidth > 500) && (
                                    <div className='divider'></div>
                          ...
                          <div className='container_cat_inter'>
                          <li><Link to="/port"  className="profile_link">Place de Port</Link></li>
                          {( screenWidth > 500) && (
                                    <div className='divider'></div>
