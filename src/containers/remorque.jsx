...
import remorquemg from '../assets/pharelogo.png'
...
const onSubmitForm = () => {
    ...
    return (
        <main className='main_home'>
		  ...
		  <img src={remorquemg} alt="logo application" className="logohome"/>
			<h1 className='titlehomeski'>remorque</h1>
		  ...
		  <h2> les meilleurs  remorque d'occasion</h2>
